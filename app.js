...
export function funnelStages(scope, prev) {
  ...
  const reachedScheduled = (l) => l.status === "won" || !!l.proposalAt || [91219187, 95677371, 91219191, 91219199, 91219203, 91219207, 91219211, 142].includes(l.stageId);
  const reachedPresented = (l) => l.status === "won" || [95677371, 91219199, 91219203, 91219207, 91219211, 142].includes(l.stageId);
